...
2. **UPS Module**:
   ...
   * Standoff pedestal: $3.5\text{ mm}$, center screw boss at $(-4.50, -7.15)$.
...
6. **Case Fasteners**:
   * 4 main M3 casing screws inserted from desk base underneath into internal pillars at $(\pm 42, -50)$ and $(\pm 42, 130)$.
